...
const rectangleINfo = document.querySelector("ul li:nth-child(2) p:nth-child(1)");
const squareInfo = document.querySelector("ul li:nth-child(2) p:nth-child(2)");
const circleINfo = document.querySelector("ul li:nth-child(2) p:nth-child(3)");
